...
Là một thành phần đóng vai trò kết nối giữa:

- Domain Entity: Chỉ chứa logic nghiệp vụ, không quan tâm database là SQL hay NoSQL, không chứa Decorator của TypeORM/Prisma.
- ORM Entity: Chỉ chứa cấu trúc bảng, các Decorator như @Column, @PrimaryGeneratedColumn.
